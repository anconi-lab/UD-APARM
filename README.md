...
(a single file with a distance between the two molecules equal to 10 Angstroms, without any relative rotation, aligned axis of inertia)

In the file "scan-list.txt," you'll find a list of all generated geometries by UD-APARM.

For testing a scan:

>cp ud-aparm-22-points-00-10-A-5stesps.inp ud-aparm.inp

>./ud-aparm-linux

Now we have the following "scan-list.txt":

<img width="483" height="888" alt="image" src="https://github.com/user-attachments/assets/4342014d-2601-4006-a557-b7be746c6f63" />

The names correspond to files generated by UD-APARM, in the current directory

Change the input (ud-aparm.inp) for testing.

Additionally, you can use some visualization software to study the supramolecular systems obtained. 
